...
if (!trait_exists('ZeyvroModuleTrait', false)) {
    trait ZeyvroModuleTrait
    {
         ...
         */
        private function zvTabIdFromClassName(string $className): int
        {
        ...
        private function zvEnsureParentTab(): int
        {
            ...
            $id_improve = $this->zvTabIdFromClassName('IMPROVE')
                ?: $this->zvTabIdFromClassName('AdminParentModulesSf');
        ...
        {
            $id_child = $this->zvTabIdFromClassName(static::ZV_TAB_CLASS);
            if ($id_child) {
        ...
        {
            $id = $this->zvTabIdFromClassName(static::ZV_TAB_CLASS);
            if ($id) {
                (new Tab($id))->delete();
            }
            $id_parent = $this->zvTabIdFromClassName('AdminZeyvroParent');
            if ($id_parent) {
