...
/**
 * v1.1.8 — un envío rechazado por Turnstile ya no se guarda en Servicio al cliente en PS 8.0 / 8.1 (ver zeyvro_turnstile.php).
 *
    ...
    if (filter_var(ini_get('opcache.enable'), FILTER_VALIDATE_BOOLEAN)) {
        ...
        if (!$ok) {
            PrestaShopLogger::addLog(
                'zeyvro_turnstile upgrade 1.1.8: OPcache not invalidated, the server may still serve the old code',
