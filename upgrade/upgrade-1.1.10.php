...
/**
 * v1.1.10 — los scripts de actualización antiguos (1.0.3 y 1.0.7) ya no usan el método estático de Tab
 * que busca por class_name, deprecado desde PrestaShop 1.7.1.0.
 *
 * Sin cambios de esquema. Como la 1.1.9 (y zeyvroseoredirect 1.7.1): invalida en OPcache solo los .php del propio módulo,
    ...
    if (filter_var(ini_get('opcache.enable'), FILTER_VALIDATE_BOOLEAN)) {
        ...
        if (!$ok) {
            PrestaShopLogger::addLog(
                'zeyvro_turnstile upgrade 1.1.10: OPcache not invalidated, the server may still serve the old code',
